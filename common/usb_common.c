...
__overridable void pd_check_dr_role(int port, enum pd_data_role dr_role, int flags)
{
...
__overridable void pd_check_pr_role(int port, enum pd_power_role pr_role, int flags)
{
	/*
